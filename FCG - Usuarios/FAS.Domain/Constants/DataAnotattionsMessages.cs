namespace FAS.Domain.Constants
{
    public static class DataAnnotationsMessages
    {
        ...
        public const string COMPAREPASSWORD = "A Senha e a Confirmação da Senha não conferem.";
        public const string RANGE = "O campo {0} deve ter o valor entre {1} e {2}.";
    }
}
