...
{
    /// <summary>
    /// Usuário/Produtor Rural (Identity) - campos mínimos: email, senha hash, status (T-002).
    /// </summary>
    public class Usuario
    {
        ...
        /// <summary>Status do produtor (Ativo/Inativo) para controle de acesso.</summary>
        public StatusProdutor Status { get; private set; }

        public Usuario() { }

        public Usuario(int id, string nome, Email email, StatusProdutor status = StatusProdutor.Ativo)
        {
            Id = id;
            Nome = nome;
            EmailUsuario = email;
        ...
        public void DefinirStatus(StatusProdutor status) => Status = status;
