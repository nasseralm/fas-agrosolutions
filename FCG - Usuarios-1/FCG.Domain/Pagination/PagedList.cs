namespace FCG.Domain.Pagination
{
    public class PagedList<T> : List<T>
    {
        ...
        public PagedList(IEnumerable<T> items, int pageNumber, int pageSize, int count)
        {
            ...
            TotalPages = (int) Math.Ceiling(count / (double) pageSize); //pegar o total de resultado da consulta e dividir pelo total de itens da página
            PageSize = pageSize;
            TotalCount = count;
